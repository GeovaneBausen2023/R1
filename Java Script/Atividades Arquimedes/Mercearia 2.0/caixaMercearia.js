...
function somarCompra() {
    ...
    if (inValor.value == "" || valor <= 0) {
        // Verifica se o campo de valor está vazio ou se o valor é inválido (menor ou igual a zero)
        alert("O campo Valor foi deixado vazio ou preenchido com valor inválido!"); // Exibe um alerta informando o erro
        ...
        alert("O campo Quantidade foi deixado vazio ou preenchido com valor inválido!"); // Exibe um alerta informando o erro
        inQtd.focus(); // Coloca o foco de volta no campo de quantidade
    } // ...
      ...
      if (qtdItens >= 20) {
        // Verifica se a quantidade total de itens já atingiu o limite de 20
        alert("Caixa Rápido (Limite de 20 itens) - Não é possível adicionar mais itens!"); // Exibe um alerta informando que não é possível adicionar mais itens
        btSomar.focus(); // Coloca o foco de volta no botão "Somar"
      } else if (qtd + qtdItens > 20) {
        // Verifica se a quantidade atual mais a quantidade do item ultrapassa o limite de 20 itens
        alert("Caixa Rápido (Limite de 20 itens) - Permitido apenas mais " + (20 - qtdItens) + " unidades!"); // Exibe um alerta informando o limite
        btSomar.focus(); // Coloca o foco de volta no botão "Somar"
        inQtd.value = 20 - qtdItens; // Define a quantidade máxima permitida para o campo de quantidade
      } else {
